...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("InventoryControlSystemDataSet2"),  _
 System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class InventoryControlSystemDataSet2
...
~dulla^@204~ eturn Me.tableSupplier
 ...
 ~dulla^@204~ turn MyBase.Relations
  ...
  ~dulla^@204~  As InventoryControlSystemDataSet2 = ~dulla^@204~ Clone,InventoryControlSystemDataSet2)~dulla^@204~ .InitVars
...
~dulla^@204~ f
  ...
  ~dulla^@204~ tionFK_Purchase_Supplier = Me.Relatio~dulla^@204~ se_Supplier")
    ...
    End Sub
        ...
        Me~dulla^@204~ = "InventoryControlSystemDataSet2"
 ~dulla^@204~ fix = ""
        Me.Namespace = "htt~dulla^@204~ rg/InventoryControlSystemDataSet2.xsd~dulla^@204~ .EnforceConstraints = true
 ...
 ~dulla^@204~ tem.Diagnostics.DebuggerNonUserCodeAt~dulla^@204~ 
  ...
  ~dulla^@204~ em.Diagnostics.DebuggerNonUserCodeAtt~dulla^@204~ 
    ...
    Public Shared F~dulla^@204~ pedDataSetSchema(ByVal xs As System.X~dulla^@204~ SchemaSet) As System.Xml.Schema.XmlSc~dulla^@204~ pe
        Dim ds As InventoryContro~dulla^@204~ t2 = New InventoryControlSystemDataSe~dulla^@204~ im type As System.Xml.Schema.XmlSchem~dulla^@204~ = New System.Xml.Schema.XmlSchemaComp~dulla^@204~     Dim sequence As System.Xml.Schema~dulla^@204~ uence = New System.Xml.Schema.XmlSche~dulla^@204~        xs.Add(ds.GetSchemaSerializabl~dulla^@204~ im any As System.Xml.Schema.XmlSchema~dulla^@204~ tem.Xml.Schema.XmlSchemaAny
 ...
 ~dulla^@204~   RaiseEvent CashSalesRowDeleting(Me,~dulla^@204~ sRowChangeEvent(CType(e.Row,CashSales~dulla^@204~ n))
     ...
     ~dulla^@204~ <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Shared F~dulla^@204~ pedTableSchema(ByVal xs As System.Xml~dulla^@204~ hemaSet) As System.Xml.Schema.XmlSche~dulla^@204~ 
            ...
            Dim ds ~dulla^@204~ ontrolSystemDataSet2 = New InventoryC~dulla^@204~ ataSet2
...
~dulla^@204~ cted Overrides Sub OnRowChanging(ByVa~dulla^@204~ .Data.DataRowChangeEventArgs)
 ...
 ~dulla^@204~ d If
    ...
    ~dulla^@204~ iagnostics.DebuggerNonUserCodeAttribu~dulla^@204~      Public Sub RemoveCreditSalesRow(~dulla^@204~ CreditSalesRow)
        ...
        ~dulla^@204~ As System.Xml.Schema.XmlSchemaComplex~dulla^@204~ stem.Xml.Schema.XmlSchemaComplexType~dulla^@204~ Dim sequence As System.Xml.Schema.Xml~dulla^@204~ e = New System.Xml.Schema.XmlSchemaSe~dulla^@204~        Dim ds As InventoryControlSyst~dulla^@204~ New InventoryControlSystemDataSet2
 ...
 ~dulla^@204~     <System.Diagnostics.DebuggerNonUs~dulla^@204~ te()>  _
  ...
  ~dulla^@204~ 
        ...
        Public Shared~dulla^@204~ TypedTableSchema(ByVal xs As System.X~dulla^@204~ SchemaSet) As System.Xml.Schema.XmlSc~dulla^@204~ pe
            ...
            Dim d~dulla^@204~ yControlSystemDataSet2 = New Inventor~dulla^@204~ mDataSet2
 ...
 ~dulla^@204~  (Not (Me.OrderRowDeletedEvent) Is No~dulla^@204~                 RaiseEvent OrderRowDe~dulla^@204~  OrderRowChangeEvent(CType(e.Row,Orde~dulla^@204~ on))
      ...
      ~dulla^@204~ RemoveOrderRow(ByVal row As OrderRow)~dulla^@204~  Me.Rows.Remove(row)
        ...
        Public Shared Fu~dulla^@204~ edTableSchema(ByVal xs As System.Xml.~dulla^@204~ emaSet) As System.Xml.Schema.XmlSchem~dulla^@204~ 
            ...
            Dim ds A~dulla^@204~ ntrolSystemDataSet2 = New InventoryCo~dulla^@204~ taSet2
...
~dulla^@204~ et
 ...
 ~dulla^@204~ Base.OnRowDeleted(e)
   ...
   ~dulla^@204~ sequence As System.Xml.Schema.XmlSche~dulla^@204~ New System.Xml.Schema.XmlSchemaSequen~dulla^@204~    Dim ds As InventoryControlSystemDa~dulla^@204~ InventoryControlSystemDataSet2
  ...
  ~dulla^@204~ 
     ...
     ~dulla^@204~ <System.Diagnostics.DebuggerNonUserCo~dulla^@204~ >  _
        ...
        Public Shared Function GetT~dulla^@204~ ma(ByVal xs As System.Xml.Schema.XmlS~dulla^@204~ System.Xml.Schema.XmlSchemaComplexTyp~dulla^@204~   Dim type As System.Xml.Schema.XmlSc~dulla^@204~ pe = New System.Xml.Schema.XmlSchemaC~dulla^@204~            Dim sequence As System.Xml~dulla^@204~ hemaSequence = New System.Xml.Schema.~dulla^@204~ ence
            Dim ds As Inventory~dulla^@204~ DataSet2 = New InventoryControlSystem~dulla^@204~          xs.Add(ds.GetSchemaSerializable)
     ...
     ~dulla^@204~  RemoveSalesInfoRow(ByVal row As Sale~dulla^@204~           Me.Rows.Remove(row)
      ~dulla^@204~       
        ...
        Public ~dulla^@204~ on GetTypedTableSchema(ByVal xs As Sy~dulla^@204~ ma.XmlSchemaSet) As System.Xml.Schema~dulla^@204~ plexType
           ...
           ~dulla^@204~ ventoryControlSystemDataSet2 = New In~dulla^@204~ lSystemDataSet2
      ...
      ~dulla^@204~ RemoveStockCardRow(ByVal row As Stock~dulla^@204~          Me.Rows.Remove(row)
       ~dulla^@204~      
        ...
        Public S~dulla^@204~ n GetTypedTableSchema(ByVal xs As Sys~dulla^@204~ a.XmlSchemaSet) As System.Xml.Schema.~dulla^@204~ lexType
            ...
            ~dulla^@204~ entoryControlSystemDataSet2 = New Inv~dulla^@204~ SystemDataSet2
...
~dulla^@204~ f (Not (Me.StockCardDetailRowChangedE~dulla^@204~ ing) Then
  ...
  ~dulla^@204~ 
       ...
       ~dulla^@204~ s InventoryControlSystemDataSet2 = Ne~dulla^@204~ ntrolSystemDataSet2
  ...
  ~dulla^@204~ Sub RemoveSupplierRow(ByVal row As Su~dulla^@204~            Me.Rows.Remove(row)
     ~dulla^@204~        
        ...
        Public~dulla^@204~ ion GetTypedTableSchema(ByVal xs As S~dulla^@204~ ema.XmlSchemaSet) As System.Xml.Schem~dulla^@204~ mplexType
          ...
          ~dulla^@204~ nventoryControlSystemDataSet2 = New I~dulla^@204~ olSystemDataSet2
...
~dulla^@204~    Return Me.eventAction
           ~dulla^@204~      End Property
    End Class
End~dulla^@204~ espace InventoryControlSystemDataSet2~dulla^@204~ 
...
~dulla^@204~ e._adapter.InsertCommand.CommandType ~dulla^@204~ .CommandType.Text
 ...
 ~dulla^@204~ d If
        ...
        Public Overloads ~dulla^@204~ unction GetData() As InventoryControl~dulla^@204~ 2.BlankTableDataTable
            Me~dulla^@204~ ctCommand = Me.CommandCollection(0)
~dulla^@204~ im dataTable As InventoryControlSyste~dulla^@204~ nkTableDataTable = New InventoryContr~dulla^@204~ et2.BlankTableDataTable
        ...
        ~dulla^@204~ ads Overridable Function Update(ByVal~dulla^@204~  InventoryControlSystemDataSet2.Blank~dulla^@204~ e) As Integer
...
~dulla^@204~ te Sub InitCommandCollection()
     ~dulla^@204~ mmandCollection = New System.Data.Sql~dulla^@204~ mand(0) {}
        ...
        Public Over~dulla^@204~ able Function Fill(ByVal dataTable As~dulla^@204~ trolSystemDataSet2.CashSalesDataTable~dulla^@204~ 
 ...
 ~dulla^@204~ turn returnValue
        ...
        Public~dulla^@204~ erridable Function GetData() As Inven~dulla^@204~ stemDataSet2.CashSalesDataTable
    ~dulla^@204~ apter.SelectCommand = Me.CommandColle~dulla^@204~          Dim dataTable As InventoryCo~dulla^@204~ taSet2.CashSalesDataTable = New Inven~dulla^@204~ stemDataSet2.CashSalesDataTable
...
~dulla^@204~ c Overloads Overridable Function Upda~dulla^@204~ Table As InventoryControlSystemDataSe~dulla^@204~ ataTable) As Integer
        ...
        Public Overloads Overrid~dulla^@204~  Update(ByVal dataSet As InventoryCon~dulla^@204~ aSet2) As Integer
...
~dulla^@204~ e._commandCollection(0).CommandType =~dulla^@204~ CommandType.Text
  ...
  ~dulla^@204~    <System.Diagnostics.DebuggerNonUse~dulla^@204~ e(),  _
        ...
        Public Overload~dulla^@204~  Function Fill(ByVal dataTable As Inv~dulla^@204~ SystemDataSet2.CreditSalesDataTable) ~dulla^@204~            Me.Adapter.SelectCommand =~dulla^@204~ llection(0)
   ...
   ~dulla^@204~ rn returnValue
        ...
        Public O~dulla^@204~ ridable Function GetData() As Invento~dulla^@204~ emDataSet2.CreditSalesDataTable
    ~dulla^@204~ apter.SelectCommand = Me.CommandColle~dulla^@204~          Dim dataTable As InventoryCo~dulla^@204~ taSet2.CreditSalesDataTable = New Inv~dulla^@204~ SystemDataSet2.CreditSalesDataTable
~dulla^@204~ e.Adapter.Fill(dataTable)
        ...
        Public Overloads O~dulla^@204~ nction Update(ByVal dataSet As Invent~dulla^@204~ temDataSet2) As Integer
...
~dulla^@204~ e._adapter.UpdateCommand.Parameters.A~dulla^@204~ .Data.SqlClient.SqlParameter("@Origin~dulla^@204~ em.Data.SqlDbType.[Char], 0, System.D~dulla^@204~ Direction.Input, 0, 0, "Fax", System.~dulla^@204~ ersion.Original, false, Nothing, "", ~dulla^@204~          Me._adapter.UpdateCommand.Pa~dulla^@204~ New System.Data.SqlClient.SqlParamete~dulla^@204~ stalAddress", System.Data.SqlDbType.I~dulla^@204~ .Data.ParameterDirection.Input, 0, 0,~dulla^@204~ ss", System.Data.DataRowVersion.Origi~dulla^@204~ thing, "", "", ""))
   ...
   ~dulla^@204~   <System.Diagnostics.DebuggerNonUser~dulla^@204~ ()>  _
      ...
      ~dulla^@204~ mandCollection(0).CommandType = Syste~dulla^@204~ dType.Text
        ...
        Public Overloads Over~dulla^@204~ ion Fill(ByVal dataTable As Inventory~dulla^@204~ DataSet2.CustomersDataTable) As Integ~dulla^@204~    Me.Adapter.SelectCommand = Me.Comm~dulla^@204~ (0)
...
~dulla^@204~ nd If
       ...
       ~dulla^@204~ ystem.Diagnostics.DebuggerNonUserCode~dulla^@204~  _
        ...
        Public Overloads~dulla^@204~ Function GetData() As InventoryContro~dulla^@204~ t2.CustomersDataTable
            Me~dulla^@204~ ctCommand = Me.CommandCollection(0)
~dulla^@204~ im dataTable As InventoryControlSyste~dulla^@204~ tomersDataTable = New InventoryContro~dulla^@204~ t2.CustomersDataTable
        ...
        Pu~dulla^@204~ s Overridable Function Update(ByVal d~dulla^@204~ nventoryControlSystemDataSet2.Custome~dulla^@204~ As Integer
...
~dulla^@204~ em.Diagnostics.DebuggerNonUserCodeAtt~dulla^@204~ 
 ...
 ~dulla^@204~ b
     ...
     ~dulla^@204~ rloads Overridable Function Fill(ByVa~dulla^@204~ s InventoryControlSystemDataSet2.Orde~dulla^@204~ s Integer
    ...
    ~dulla^@204~ erloads Overridable Function GetData(~dulla^@204~ yControlSystemDataSet2.OrderDataTable~dulla^@204~  Me.Adapter.SelectCommand = Me.Comman~dulla^@204~ )
            Dim dataTable As Inven~dulla^@204~ stemDataSet2.OrderDataTable = New Inv~dulla^@204~ SystemDataSet2.OrderDataTable
  ...
  ~dulla^@204~ Overloads Overridable Function Update~dulla^@204~ ble As InventoryControlSystemDataSet2~dulla^@204~ le) As Integer
...
~dulla^@204~    If (Me._commandCollection Is Nothi~dulla^@204~                  Me.InitCommandCollec~dulla^@204~          End If
 ...
 ~dulla^@204~   "riginal_Description) AND ((@IsNull~dulla^@204~  AND [UnitCost] IS NULL) OR ([Uni"& _~dulla^@204~       "tCost] = @Original_UnitCost)) ~dulla^@204~ Price1] = @Original_SellingPrice1) AN~dulla^@204~           "D ([SellingPrice2] = @Orig~dulla^@204~ rice2) AND ((@IsNull_QtyAtShop1 = 1 A~dulla^@204~               "QtyAtShop1] IS NULL) O~dulla^@204~ 1] = @Original_QtyAtShop1)) AND ((@Is~dulla^@204~ 
   ...
   ~dulla^@204~ commandCollection = New System.Data.S~dulla^@204~ ommand(0) {}
        ...
        Public Ov~dulla^@204~ idable Function Fill(ByVal dataTable ~dulla^@204~ ontrolSystemDataSet2.ProductsDataTabl~dulla^@204~ 
...
~dulla^@204~ eturn returnValue
        ...
        Publi~dulla^@204~ verridable Function GetData() As Inve~dulla^@204~ ystemDataSet2.ProductsDataTable
    ~dulla^@204~ apter.SelectCommand = Me.CommandColle~dulla^@204~          Dim dataTable As InventoryCo~dulla^@204~ taSet2.ProductsDataTable = New Invent~dulla^@204~ temDataSet2.ProductsDataTable
      ~dulla^@204~ ter.Fill(dataTable)
            Retu~dulla^@204~ 
        End Function
        
    ~dulla^@204~ iagnostics.DebuggerNonUserCodeAttribu~dulla^@204~       System.ComponentModel.Design.He~dulla^@204~ ibute("vs.data.TableAdapter")>  _
  ~dulla^@204~ Overloads Overridable Function Update~dulla^@204~ ble As InventoryControlSystemDataSet2~dulla^@204~ Table) As Integer
            Return~dulla^@204~ pdate(dataTable)
        End Functio~dulla^@204~         <System.Diagnostics.DebuggerN~dulla^@204~ ribute(),  _
         System.Compone~dulla^@204~ n.HelpKeywordAttribute("vs.data.Table~dulla^@204~ 
        Public Overloads Overridabl~dulla^@204~ date(ByVal dataSet As InventoryContro~dulla^@204~ t2) As Integer
...
~dulla^@204~ f (Me.ClearBeforeFill = true) Then
 ~dulla^@204~   dataTable.Clear
        ...
        <System~dulla^@204~ DebuggerNonUserCodeAttribute(),  _
 ~dulla^@204~ m.ComponentModel.Design.HelpKeywordAt~dulla^@204~ ata.TableAdapter"),  _
         Syst~dulla^@204~ odel.DataObjectMethodAttribute(System~dulla^@204~ el.DataObjectMethodType.[Select], tru~dulla^@204~    Public Overloads Overridable Funct~dulla^@204~  As InventoryControlSystemDataSet2.Pu~dulla^@204~ le
            Me.Adapter.SelectComm~dulla^@204~ andCollection(0)
            Dim dataTable As InventoryControlSystemDataSet2.P~dulla^@204~ ble = New InventoryControlSystemDataS~dulla^@204~ ataTable
            Me.Adapter.Fill~dulla^@204~             Return dataTable
       ~dulla^@204~ 
        
        <System.Diagnosti~dulla^@204~ nUserCodeAttribute(),  _
         Sy~dulla^@204~ tModel.Design.HelpKeywordAttribute("v~dulla^@204~ dapter")>  _
        Public Overload~dulla^@204~  Function Update(ByVal dataTable As I~dulla^@204~ olSystemDataSet2.PurchaseDataTable) A~dulla^@204~           Return Me.Adapter.Update(da~dulla^@204~      End Function
        
        ~dulla^@204~ ostics.DebuggerNonUserCodeAttribute()~dulla^@204~   System.ComponentModel.Design.HelpKe~dulla^@204~ e("vs.data.TableAdapter")>  _
      ~dulla^@204~ loads Overridable Function Update(ByV~dulla^@204~  InventoryControlSystemDataSet2) As I~dulla^@204~        Return Me.Adapter.Update(dataS~dulla^@204~ ")
        End Function
...
~dulla^@204~ e._adapter.UpdateCommand.Parameters.A~dulla^@204~ .Data.SqlClient.SqlParameter("@Origin~dulla^@204~ ystem.Data.SqlDbType.[Char], 0, Syste~dulla^@204~ terDirection.Input, 0, 0, "Origin", S~dulla^@204~ taRowVersion.Original, false, Nothing~dulla^@204~ )
  ...
  ~dulla^@204~  Sub InitConnection()
   ...
   ~dulla^@204~ ComponentModel.DataObjectMethodAttrib~dulla^@204~ mponentModel.DataObjectMethodType.Fil~dulla^@204~ 
        Public Overloads Overridable~dulla^@204~ l(ByVal dataTable As InventoryControl~dulla^@204~ 2.PurchaseInfoDataTable) As Integer
~dulla^@204~ e.Adapter.SelectCommand = Me.CommandC~dulla^@204~ 
 ...
 ~dulla^@204~ m.Diagnostics.DebuggerNonUserCodeAttr~dulla^@204~          System.ComponentModel.Design~dulla^@204~ ttribute("vs.data.TableAdapter"),  _~dulla^@204~ tem.ComponentModel.DataObjectMethodAt~dulla^@204~ m.ComponentModel.DataObjectMethodType~dulla^@204~ ue)>  _
        Public Overloads Overridable Function GetData() As InventoryCo~dulla^@204~ taSet2.PurchaseInfoDataTable
       ~dulla^@204~ er.SelectCommand = Me.CommandCollecti~dulla^@204~       Dim dataTable As InventoryContr~dulla^@204~ et2.PurchaseInfoDataTable = New Inven~dulla^@204~ stemDataSet2.PurchaseInfoDataTable
...
~dulla^@204~ e._adapter.UpdateCommand.Parameters.A~dulla^@204~ .Data.SqlClient.SqlParameter("@Credit~dulla^@204~ o", System.Data.SqlDbType.NVarChar, 0~dulla^@204~ .ParameterDirection.Input, 0, 0, "Cre~dulla^@204~ ceNo", System.Data.DataRowVersion.Cur~dulla^@204~ Nothing, "", "", ""))
 ...
 ~dulla^@204~ m.Diagnostics.DebuggerNonUserCodeAttr~dulla^@204~          System.ComponentModel.Design~dulla^@204~ ttribute("vs.data.TableAdapter"),  _~dulla^@204~ tem.ComponentModel.DataObjectMethodAt~dulla^@204~ m.ComponentModel.DataObjectMethodType~dulla^@204~   _
        Public Overloads Overrid~dulla^@204~  Fill(ByVal dataTable As InventoryCon~dulla^@204~ aSet2.SalesInfoDataTable) As Integer~dulla^@204~ Me.Adapter.SelectCommand = Me.Command~dulla^@204~ 
...
~dulla^@204~ em.Diagnostics.DebuggerNonUserCodeAtt~dulla^@204~ 
   ...
   ~dulla^@204~ dataTable As InventoryControlSystemDa~dulla^@204~ nfoDataTable = New InventoryControlSy~dulla^@204~ SalesInfoDataTable
        ...
        <System~dulla^@204~ DebuggerNonUserCodeAttribute(),  _
 ~dulla^@204~ m.ComponentModel.Design.HelpKeywordAt~dulla^@204~ ata.TableAdapter")>  _
        Publi~dulla^@204~ verridable Function Update(ByVal data~dulla^@204~ ntoryControlSystemDataSet2.SalesInfoD~dulla^@204~ Integer
...
~dulla^@204~    dataTable.Clear
        ...
        <Syste~dulla^@204~ .DebuggerNonUserCodeAttribute(),  _
~dulla^@204~ em.ComponentModel.Design.HelpKeywordA~dulla^@204~ data.TableAdapter"),  _
         Sys~dulla^@204~ Model.DataObjectMethodAttribute(Syste~dulla^@204~ del.DataObjectMethodType.[Select], tr~dulla^@204~     Public Overloads Overridable Func~dulla^@204~ ) As InventoryControlSystemDataSet2.S~dulla^@204~ able
            Me.Adapter.SelectCo~dulla^@204~ mmandCollection(0)
            Dim d~dulla^@204~ nventoryControlSystemDataSet2.StockCa~dulla^@204~  New InventoryControlSystemDataSet2.S~dulla^@204~ able
            Me.Adapter.Fill(dat~dulla^@204~         Return dataTable
        End~dulla^@204~       
        <System.Diagnostics.D~dulla^@204~ rCodeAttribute(),  _
         System~dulla^@204~ el.Design.HelpKeywordAttribute("vs.da~dulla^@204~ er")>  _
        Public Overloads Ov~dulla^@204~ ction Update(ByVal dataTable As Inven~dulla^@204~ stemDataSet2.StockCardDataTable) As I~dulla^@204~        Return Me.Adapter.Update(dataT~dulla^@204~   End Function
        ...
        P~dulla^@204~ ds Overridable Function Update(ByVal ~dulla^@204~ ventoryControlSystemDataSet2) As Inte~dulla^@204~     Return Me.Adapter.Update(dataSet,~dulla^@204~ 
        End Function
...
~dulla^@204~    "InvoiceNo)"
 ...
 ~dulla^@204~   "ce, StockCardNo FROM dbo.StockCard~dulla^@204~         Me._commandCollection(0).Comm~dulla^@204~ tem.Data.CommandType.Text
      ...
      ~dulla^@204~ loads Overridable Function Fill(ByVal~dulla^@204~  InventoryControlSystemDataSet2.Stock~dulla^@204~ aTable) As Integer
            Me.Ad~dulla^@204~ ommand = Me.CommandCollection(0)
...
~dulla^@204~ unction
        ...
        <System.Di~dulla^@204~ uggerNonUserCodeAttribute(),  _
    ~dulla^@204~ omponentModel.Design.HelpKeywordAttri~dulla^@204~ .TableAdapter"),  _
         System.~dulla^@204~ l.DataObjectMethodAttribute(System.Co~dulla^@204~ DataObjectMethodType.[Select], true)>~dulla^@204~ Public Overloads Overridable Function~dulla^@204~  InventoryControlSystemDataSet2.Stock~dulla^@204~ aTable
            Me.Adapter.Select~dulla^@204~ CommandCollection(0)
            Dim~dulla^@204~  InventoryControlSystemDataSet2.Stock~dulla^@204~ aTable = New InventoryControlSystemDa~dulla^@204~ ardDetailDataTable
            Me.Ad~dulla^@204~ taTable)
            Return dataTabl~dulla^@204~ d Function
        
        <System~dulla^@204~ DebuggerNonUserCodeAttribute(),  _
 ~dulla^@204~ m.ComponentModel.Design.HelpKeywordAt~dulla^@204~ ata.TableAdapter")>  _
        Publi~dulla^@204~ verridable Function Update(ByVal data~dulla^@204~ ntoryControlSystemDataSet2.StockCardD~dulla^@204~ e) As Integer
            Return Me.~dulla^@204~ e(dataTable)
        End Function
 ~dulla^@204~     <System.Diagnostics.DebuggerNonUs~dulla^@204~ te(),  _
         System.ComponentMo~dulla^@204~ lpKeywordAttribute("vs.data.TableAdap~dulla^@204~       Public Overloads Overridable Fu~dulla^@204~ (ByVal dataSet As InventoryControlSys~dulla^@204~ As Integer
...
~dulla^@204~ f (Me.ClearBeforeFill = true) Then
 ~dulla^@204~   dataTable.Clear
        ...
        <System~dulla^@204~ DebuggerNonUserCodeAttribute(),  _
 ~dulla^@204~ m.ComponentModel.Design.HelpKeywordAt~dulla^@204~ ata.TableAdapter"),  _
         Syst~dulla^@204~ odel.DataObjectMethodAttribute(System~dulla^@204~ el.DataObjectMethodType.[Select], tru~dulla^@204~    Public Overloads Overridable Funct~dulla^@204~  As InventoryControlSystemDataSet2.Su~dulla^@204~ le
            Me.Adapter.SelectComm~dulla^@204~ andCollection(0)
            Dim dat~dulla^@204~ entoryControlSystemDataSet2.SupplierD~dulla^@204~ w InventoryControlSystemDataSet2.SupplierDataTable
            Me.Adapter.Fill~dulla^@204~             Return dataTable
       ~dulla^@204~ 
        
        <System.Diagnosti~dulla^@204~ nUserCodeAttribute(),  _
         Sy~dulla^@204~ tModel.Design.HelpKeywordAttribute("v~dulla^@204~ dapter")>  _
        Public Overload~dulla^@204~  Function Update(ByVal dataTable As I~dulla^@204~ olSystemDataSet2.SupplierDataTable) A~dulla^@204~           Return Me.Adapter.Update(da~dulla^@204~      End Function
...
~dulla^@204~ te Sub InitCommandCollection()
     ~dulla^@204~ mmandCollection = New System.Data.Sql~dulla^@204~ mand(0) {}
       ...
       ~dulla^@204~      
        ...
        Pub~dulla^@204~  Overridable Function Fill(ByVal data~dulla^@204~ ntoryControlSystemDataSet2.UsersDataT~dulla^@204~ ger
        ...
        Pu~dulla^@204~ s Overridable Function GetData() As I~dulla^@204~ olSystemDataSet2.UsersDataTable
    ~dulla^@204~ apter.SelectCommand = Me.CommandColle~dulla^@204~          Dim dataTable As InventoryCo~dulla^@204~ taSet2.UsersDataTable = New Inventory~dulla^@204~ DataSet2.UsersDataTable
            ~dulla^@204~ ll(dataTable)
            Return dat~dulla^@204~    End Function
        
        <S~dulla^@204~ tics.DebuggerNonUserCodeAttribute(), ~dulla^@204~ System.ComponentModel.Design.HelpKeyw~dulla^@204~ "vs.data.TableAdapter")>  _
        ~dulla^@204~ ads Overridable Function Update(ByVal~dulla^@204~  InventoryControlSystemDataSet2.Users~dulla^@204~  Integer
